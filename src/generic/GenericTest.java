...
//        arr1.add("String1");
        ...
        System.out.println(arr1.get(2)); //인덱스 2번에 해당하는 데이터를 가져옴

        arr1.remove("String 1"); //"String 1"이라는 데이터를 찾아서 삭제
        arr1.remove(1); //인덱스 1번에 해당하는 데이터 삭제
        System.out.println(arr1.get(1)); //인덱스 2번에 해당하는 데이터를 가져옴
        System.out.println("\n ---forEach---");
        arr1.forEach(System.out::println);

//        Stream<String> stringStream = arr1.stream().map((s -> {
...
//        stringStream.forEach(System.out::println);
        ...
        LinkedList<Integer> intArr = new LinkedList<>(); //정수를 저장할 수 있는 링크드 리스트
