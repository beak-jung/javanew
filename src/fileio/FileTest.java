...
public class FileTest {
    ...
    public static void saveObject(String fileName, Person person) {
        ...
        try (FileOutputStream fos = new FileOutputStream(fileName); ObjectOutputStream oos = new ObjectOutputStream(fos)) {
            oos.writeObject(person); //Serialize : 인스턴스에서 데이터 요소만 분리하여 메모리 스토림으로 만들어줌
        } catch (IOException e) {
            System.out.println(e.getMessage());
        }
    }
...
//    }
        ...
        if(p3 != null)
            ...
            System.out.println("Person Object를 불러 올 수 없습니다");
...
//        else
//            System.out.println("person Object를 물러올 수 없습니다.");
